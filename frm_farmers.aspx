<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_farmers.aspx.cs" Inherits="frm_farmers" %>
    ...
    <div>
        ...
        <table style="width: 35%;border-width:3px;border-style:solid;border-color:black;" cellspacing="4px" cellpadding="4px">
            <tr style="height:50px">
                <td colspan="2" style="text-align:center;background-color:#006600;color:white">
                    <asp:Label ID="Label1" runat="server" Text="Add Farmers" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                </td>
            ...
            <tr>
             ...
             <tr>
              ...
              <tr>
                ...
                <td>
                   <asp:TextBox ID="txtvillage" runat="server" placeholder="Enter Village" Style="padding-left:5px" Height="30px" Width="250px" Visible="False"></asp:TextBox>
             ...
             <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:Button ID="btnsubmit" runat="server" Text="Submit" Height="40px" Width="260px" BackColor="#006600" ForeColor="White" Font-Bold="True" Font-Size="Large" OnClick="btnsubmit_Click"></asp:Button>
                </td>
