<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_checkresponse.aspx.cs" Inherits="frm_checkresponse" %>
        ...
        <table style="width:40%;border-width:3px;border-style:solid;border-color:black" cellspacing="5px" cellpadding="5px">
            <tr style="height:50px">
                <td colspan="2" style="text-align:center;background-color: #cc7a00">
                    <asp:Label ID="lblquery" runat="server" Text="Check Response" Font-Bold="True" Font-Size="X-Large" ForeColor="White"></asp:Label>
                </td>
                </tr>
             <tr>
