...
public partial class frm_changepassword : System.Web.UI.Page
{
    ...
    protected void btnchangepassword_Click(object sender, EventArgs e)
    {
        ...
        f1.truncate("truncate table rainwise_crop");
        ...
        if (FileUpload1.HasFile)
        {
                ...
                FileUpload1.PostedFile.ContentType == Excel2010ContentType)
            {
                ...
                {
                    OleDbCommand command = new OleDbCommand("Select * FROM [Rain_Soil$]", connection1);
                    ...
                    objbulk.DestinationTableName = "rainwise_crop";
                    //Mapping Table column    
                    objbulk.ColumnMappings.Add("crop", "crop");
                    objbulk.ColumnMappings.Add("min_rainfall", "min_rainfall");
                    objbulk.ColumnMappings.Add("max_rainfall", "max_rainfall");
                    objbulk.ColumnMappings.Add("fertility", "fertility");
